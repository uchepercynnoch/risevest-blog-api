...
export default class HttpStatus {
  ...
  public static ACCEPTED = new HttpStatus(HTTP_STATUS_CODES['201'], HTTP_STATUS_CODES.ACCEPTED);
  public static CREATED = new HttpStatus(HTTP_STATUS_CODES['202'], HTTP_STATUS_CODES.CREATED);
